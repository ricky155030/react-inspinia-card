...
gulp.task('build-html', function() {
  let replace = {
    css: [
      'http://' + CONFIG.HOSTNAME + ':' + CONFIG.PORT + '/static/css/bootstrap.min.css',
      'http://' + CONFIG.HOSTNAME + ':' + CONFIG.PORT + '/static/css/inspinia.css',
      'http://' + CONFIG.HOSTNAME + ':' + CONFIG.PORT + '/static/vendor/animate.css/animate.min.css',
